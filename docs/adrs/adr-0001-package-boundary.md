# ADR 0001: @plasius/game-audio Package Boundary
...
Keep playback intent, bus policy, asset references, telemetry event shape, and rollout constants in a browser-independent core package. Runtime adapters consume these contracts instead of inventing package-local command shapes.
